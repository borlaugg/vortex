...
void kernel_body(kernel_arg_t* __UNIFORM__ arg) {
    ...
    vx_tile(0b00000000000000001000000000000000,16);
    vx_printf("B (thread %d)\n", i);
    // vx_barrier(0,0b00000000000000001000000000000000);
    vx_printf("C (thread %d)\n", i);
    vx_tile(0b10000000000000000000000000000000,16);
    vx_printf("D (thread %d)\n", i);
    

    vx_tile(0b10000000000000001000000000000000,16);
    if(i%16 == 0)
    {
        vx_printf("E (thread %d)\n", i);
	}

	vx_tile(0b10000000000000000000000000000000,32); //default config
    ...
    // vx_tile(0b10101010101010101010101010101010,2);

    // vx_printf("B (thread %d)\n", vx_thread_id());

    // vx_barrier(0,0b10101010101010101010101010101010);
